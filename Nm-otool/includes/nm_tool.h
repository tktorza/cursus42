...
# define VERIF(ptr, ptr2) if ((ptr && !verif(ptr)) || (ptr2 && !verif(ptr2))) {return (file_broken());}
...
void					display_out_64(struct nlist_64 elem, char *str,
	char type, t_symtab *symt);
