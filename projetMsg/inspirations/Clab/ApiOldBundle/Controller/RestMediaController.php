...
use Clab\ApiOldBundle\Form\Type\Media\RestGalleryType;
...
class RestMediaController extends FOSRestController
{
     ...
     * )
     */
    public function uploadAction($entityType, $entityId)
    {
        $imageManager = $this->get('app_media.image_manager');

        list($success, $content) = $imageManager->upload($entityType, $entityId, $this->get('api.session_manager')->getUser());
