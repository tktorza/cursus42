...
use Clab\ApiOldBundle\Form\Type\Foodtruck\RestEditEventType;
...
class RestFoodtruckController extends FOSRestController
{
     ...
     * )
     */
    public function publishAction(Restaurant $restaurant, Request $request)
    {
        $foodtruck = $this->get('clab_ttt.foodtruck_manager')->createFoodtruck($restaurant, '0 day', false);
        $validationManager = $this->get('clab_ttt.validation_manager');
     ...
     * )
     */
    public function cancelAction(Restaurant $restaurant, Request $request)
    {
     ...
     * )
     */
    public function closeAction(Restaurant $restaurant, Request $request)
    {
        $foodtruck = $this->get('clab_ttt.foodtruck_manager')->createFoodtruck($restaurant, '0 day', false);
        $validationManager = $this->get('clab_ttt.validation_manager');
