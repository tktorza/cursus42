...
class Mailer implements MailerInterface
{
    ...
    public function sendSubscriptionUpdatedEmail(UserInterface $user)
    {
        ...
        $rendered = $this->templating->render('ClabStripeBundle:Email/subscription_updated.html.twig', array(
            'user' => $user,
    ...
    {
        $rendered = $this->templating->render('ClabStripeBundle:Email/charge_succeeded.html.twig', array(
            'user' => $user,
            'data' => $data,
            'email_signature' => $this->parameters['email_signature'],
        ));
    ...
    {
        $rendered = $this->templating->render('ClabStripeBundle:Email/charge_failed.html.twig', array(
            'user' => $user,
            'data' => $data,
            'email_signature' => $this->parameters['email_signature'],
        ));
    ...
    {
        $rendered = $this->templating->render('ClabStripeBundle:Email/invoice_payment_succeeded.html.twig', array(
            'user' => $user,
            'data' => $data,
            'email_signature' => $this->parameters['email_signature'],
        ));
    ...
    {
        $rendered = $this->templating->render('ClabStripeBundle:Email/invoice_payment_failed.html.twig', array(
            'user' => $user,
            'data' => $data,
            'email_signature' => $this->parameters['email_signature'],
        ));
    ...
    {
        $rendered = $this->templating->render('ClabStripeBundle:Email:account_connected.html.twig', array(
            'user' => $user,
            'email_signature' => $this->parameters['email_signature'],
        ));
        $this->sendEmail($rendered, $this->parameters['from_email'], $user->getEmail());
    ...
    {
        $rendered = $this->templating->render('ClabStripeBundle:Email/account_application_deauthorized.html.twig', array(
            'user' => $user,
            'email_signature' => $this->parameters['email_signature'],
        ));
        $this->sendEmail($rendered, $this->parameters['from_email'], $user->getEmail());
